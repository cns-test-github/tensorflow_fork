...
sdy.mesh @mesh_x_4_y_2_z_2 = <["x"=2, "y"=4, "z"=2]>
...
func.func @all_reduce_single_axis_3(%arg0: tensor<8x8xf32> {sdy.sharding = #sdy.sharding<@mesh_x_4_y_2_z_2, [{"x"}, {"z"}]>}) -> tensor<8x8xf32> {
  // CHECK{LITERAL}:  replica_groups = dense<[[0, 2, 4, 6], [1, 3, 5, 7], [8, 10, 12, 14], [9, 11, 13, 15]]>
  %0 = sdy.all_reduce {"y"} %arg0 out_sharding=<@mesh_x_4_y_2_z_2, [{"x"}, {"z"}]> : tensor<8x8xf32>
  return %0 : tensor<8x8xf32>
}
